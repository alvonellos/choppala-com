  ...
  public projects: Project[] = [
    {
      ...
      responsibilities: `Responsible for creating efficient design and developing User Interaction screens using HTML5,
        ...
        Worked on Apache kafka on messaging system that communicates the data movement from different sources
        via Apache kafka client.
        Worked on developing Restful endpoints to cache application specific data in in-memory data clusters
        like Redis and exposed them with Restful endpoints by using Redis Cache.
        ...
        Performed code and unit testing for complex scope modules and projects while diagnosing
        critical issues.
        ...
        surefire plugin.
        Researched, designed, tested, and evaluated technologies for building systems.
        ...
        Performed functional & technical analysis for mission-critical projects supporting several
